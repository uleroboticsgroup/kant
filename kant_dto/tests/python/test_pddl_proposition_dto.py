...
class TestPddlPropositionDto(unittest.TestCase):
    ...
    def test_pddl_proposition_dto_str_no_objects(self):
        ...
        self.assertEqual("(robot_at)", str(self.pddl_proposition_dto))
    ...
    def test_pddl_proposition_dto_get_pddl_objects(self):
        ...
        self.assertEqual("rb1", str(pddl_objects_list[0].get_name()))
        self.assertEqual("wp1", str(pddl_objects_list[1].get_name()))
    ...
    def test_pddl_proposition_dto_eq_true(self):
        pddl_proposition_dto = PddlPropositionDto(self._robot_at, [self._rb1, self._wp1])
        result = self.pddl_proposition_dto == pddl_proposition_dto
        self.assertTrue(result)

    def test_pddl_proposition_dto_eq_false_bad_objects(self):
        pddl_proposition_dto = PddlPropositionDto(self._robot_at, [self._wp1, self._rb1])
        result = self.pddl_proposition_dto == pddl_proposition_dto
        self.assertFalse(result)

    def test_pddl_proposition_dto_eq_false_bad_len(self):
        pddl_proposition_dto = PddlPropositionDto(self._robot_at, [self._wp1])
        result = self.pddl_proposition_dto == pddl_proposition_dto
        self.assertFalse(result)

    def test_pddl_proposition_dto_eq_false_bad_predicate(self):
        _robot_at = PddlPredicateDto("robot_on", [self._robot_type, self._wp_type])
        pddl_proposition_dto = PddlPropositionDto(_robot_at, [self._rb1, self._wp1])
        result = self.pddl_proposition_dto == pddl_proposition_dto
        self.assertFalse(result)
