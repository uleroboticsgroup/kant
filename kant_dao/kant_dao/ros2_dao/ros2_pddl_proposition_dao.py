...
from kant_msgs.srv import UpdatePddlProposition, GetPddlProposition
...
class Ros2PddlPropositionDao(PddlPropositionDao):
    ...
    def __init__(self, node: Node):
        ...
        # srv clients
        self._get_client = self.node.create_client(GetPddlProposition, "get_propositions")
    ...
    def _ros2_get(
        self, get_type: int, predicate_name: str = ""
    ) -> List[PddlPropositionDto]:
        """ros2_get method
    ...
    def _ros2_update(
        self, pddl_proposition_dto: PddlPropositionDto, update_type: int
    ) -> bool:
    ...
    def get_by_predicate(self, predicate_name: str) -> List[PddlPropositionDto]:
        ...
        pddl_proposition_dto_list = self._ros2_get(
            GetPddlProposition.Request.BY_PREDICATE, predicate_name=predicate_name
        )
    ...
    def get_goals(self) -> List[PddlPropositionDto]:
        ...
        pddl_proposition_dto_list = self._ros2_get(GetPddlProposition.Request.GOALS)
    ...
    def get_no_goals(self) -> List[PddlPropositionDto]:
        ...
        pddl_proposition_dto_list = self._ros2_get(GetPddlProposition.Request.NO_GOALS)
    ...
    def get_all(self) -> List[PddlPropositionDto]:
        ...
        """
        pddl_proposition_dto_list = self._ros2_get(GetPddlProposition.Request.ALL)
    ...
    def _save(self, pddl_proposition_dto: PddlPropositionDto) -> bool:
        ...
        if not pddl_proposition_dto in self.get_by_predicate(predicate_name):
            succ = self._ros2_update(pddl_proposition_dto, UpdateKnowledge.SAVE)
            return succ
    ...
    def delete(self, pddl_proposition_dto: PddlPropositionDto) -> bool:
        ...
        succ = self._ros2_update(pddl_proposition_dto, UpdateKnowledge.DELETE)
        return succ
