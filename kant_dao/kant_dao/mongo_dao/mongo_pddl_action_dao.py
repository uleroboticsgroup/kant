...
from kant_dao.mongo_dao import MongoDao, MongoPddlTypeDao, MongoPddlPredicateDao
...
from kant_dto import PddlTypeDto, PddlConditionEffectDto, PddlActionDto, PddlObjectDto
...
class MongoPddlActionDao(PddlActionDao, MongoDao):
    ...
    def __condition_effect_model_to_dto(
        self, pddl_condition_effect_model: PddlConditionEffectModel, parameter_dict: dict
    ...
    def _model_to_dto(self, pddl_action_model: PddlActionModel) -> PddlActionDto:
        ...
        pddl_action_dto = PddlActionDto(pddl_action_model.action_name)
        ...
        for pddl_parameter_model in pddl_action_model.parameters:
            pddl_type_dto = PddlTypeDto(pddl_parameter_model.type.name)
            pddl_object_dto = PddlObjectDto(pddl_type_dto, pddl_parameter_model.name)
    ...
    def __condition_effect_dto_to_model(
        self, pddl_dto_condition_effect: PddlConditionEffectDto, parameter_dict: dict
    ) -> PddlConditionEffectModel:
        ...
        for param in pddl_dto_condition_effect.get_objects():
            ...
            pddl_condition_model.parameters.append(parameter_dict[param.get_name()])
    ...
    def _dto_to_model(self, pddl_action_dto: PddlActionDto) -> PddlActionModel:
        ...
        for param in pddl_action_dto.get_parameters():
            pddl_type_model = self._me_pddl_type_dao._dto_to_model(param.get_type())
            ...
            pddl_action_model.parameters.append(pddl_parameter_model)
        ...
        for pddl_condition_dto in pddl_action_dto.get_conditions():
            ...
            if pddl_condition_model.predicate not in pddl_action_model._predicates:
                pddl_action_model._predicates.append(pddl_condition_model.predicate)
        ...
        for pddl_effect_dto in pddl_action_dto.get_effects():
            ...
            if pddl_effect_model.predicate not in pddl_action_model._predicates:
                pddl_action_model._predicates.append(pddl_effect_model.predicate)
    ...
    def _check_pddl_condition_efect_dto(
        self,
        pddl_condition_effect_dto: PddlConditionEffectDto,
        pddl_parameter_dtos: PddlObjectDto,
    ) -> bool:
        ...
        if len(pddl_condition_effect_dto.get_objects()) != len(
            pddl_condition_effect_dto.get_predicate().get_types()
        ):
            return False
    ...
    def _check_pddl_action_dto(self, pddl_action_dto: PddlActionDto) -> bool:
        ...
        for pddl_condi_effect_dto in (
            ...
            if not self._check_pddl_condition_efect_dto(
                pddl_condi_effect_dto, pddl_action_dto.get_parameters()
            ):
                return False

        return True

    def _check_pddl_condition_efect_model(
        self,
        pddl_condition_effect_model: PddlConditionEffectModel,
        pddl_parameter_models: PddlParameterModel,
    ) -> bool:
        ...
        # check if proposition is correct
        if len(pddl_condition_effect_model.parameters) != len(
            pddl_condition_effect_model.predicate.types
        ):
            return False
        ...
        for pddl_parameter_model, pddl_type_model in zip(
            pddl_parameter_models, pddl_type_models
        ):
    ...
    def _check_pddl_action_model(self, pddl_action_model: PddlActionModel) -> bool:
        ...
        for pddl_condi_effect_model in (
            pddl_action_model.conditions + pddl_action_model.effects
        ):
            ...
            if not self._check_pddl_condition_efect_model(
                pddl_condi_effect_model, pddl_action_model.parameters
            ):
                return False
    ...
    def get(self, action_name: str) -> PddlActionDto:
        ...
        pddl_action_model = PddlActionModel.objects(action_name=action_name)
        ...
        if pddl_action_model:
            ...
            pddl_action_dto = self._model_to_dto(pddl_action_model)
            return pddl_action_dto
    ...
    def _save(self, pddl_action_dto: PddlActionDto) -> bool:
        ...
        pddl_action_model = self._dto_to_model(pddl_action_dto)
