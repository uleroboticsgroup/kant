...
from kant_knowledge_base.knowledge_base import KnowledgeBase

from simple_node import Node


class KnowledgeBaseNode(Node):
    """Knowledge Base Node Class"""

    def __init__(self):

        super().__init__("knowledge_base_node")
        ...
        # types srvs
        self.create_service(GetPddlType, "get_types", self.get_types)

        self.create_service(UpdatePddlType, "update_type", self.update_type)

        self.create_service(Empty, "delete_all_types", self.delete_all_types)

        # objects srvs
        self.create_service(GetPddlObject, "get_objects", self.get_objects)

        self.create_service(UpdatePddlObject, "update_object", self.update_object)

        self.create_service(Empty, "delete_all_objects", self.delete_all_objects)

        # predicates srvs
        self.create_service(GetPddlPredicate, "get_predicates", self.get_predicates)

        self.create_service(
            UpdatePddlPredicate, "update_predicate", self.update_predicate
        )

        self.create_service(Empty, "delete_all_predicates", self.delete_all_predicates)

        # propositions srvs
        self.create_service(GetPddlProposition, "get_propositions", self.get_propositions)
        ...
        # actions srvs
        self.create_service(GetPddlAction, "get_actions", self.get_actions)

        self.create_service(UpdatePddlAction, "update_action", self.update_action)

        self.create_service(Empty, "delete_all_actions", self.delete_all_actions)

    #### types ####

    def get_types(
        self, req: GetPddlType.Request, res: GetPddlType.Response
    ) -> GetPddlType.Response:
        ...
        if req.type_name:
            ...
            if pddl_type_dto:
                ...
                pddl_type_msg = self.dto_msg_parser.type_dto_to_msg(pddl_type_dto)
    ...
    def update_type(
        self, req: UpdatePddlType.Request, res: UpdatePddlType.Response
    ) -> UpdatePddlType.Response:
    ...
    def delete_all_types(self, req: Empty.Request, res: Empty.Response) -> Empty.Response:
    ...
    def get_objects(
        self, req: GetPddlObject.Request, res: GetPddlObject.Response
    ) -> GetPddlObject.Response:
        ...
        if req.object_name:
            ...
            if pddl_object_dto:
                ...
                pddl_object_msg = self.dto_msg_parser.object_dto_to_msg(pddl_object_dto)
    ...
    def update_object(
        self, req: UpdatePddlObject.Request, res: UpdatePddlObject.Response
    ) -> UpdatePddlObject.Response:
        ...
        pddl_object_dto = self.msg_dto_parser.object_msg_to_dto(req.pddl_object)
    ...
    def get_predicates(
        self, req: GetPddlPredicate.Request, res: GetPddlPredicate.Response
    ) -> GetPddlPredicate.Response:
        ...
        if req.predicate_name:
            ...
            pddl_predicate_dto = self.knowledge_base.get_predicate(req.predicate_name)
    ...
    def update_predicate(
        self, req: UpdatePddlPredicate.Request, res: UpdatePddlPredicate.Response
    ) -> UpdatePddlPredicate.Response:
        ...
        pddl_predicate_dto = self.msg_dto_parser.predicate_msg_to_dto(req.pddl_predicate)
    ...
    def get_propositions(
        self, req: GetPddlProposition.Request, res: GetPddlProposition.Response
    ) -> GetPddlProposition.Response:
    ...
    def update_proposition(
        self, req: UpdatePddlProposition.Request, res: UpdatePddlProposition.Response
    ) -> UpdatePddlProposition.Response:
    ...
    def get_actions(
        self, req: GetPddlAction.Request, res: GetPddlAction.Response
    ) -> GetPddlAction.Response:
        """srv callback to get types
        ...
        if req.action_name:
            ...
            if pddl_action_dto:
                ...
                pddl_action_msg = self.dto_msg_parser.action_dto_to_msg(pddl_action_dto)
    ...
    def update_action(
        self, req: UpdatePddlAction.Request, res: UpdatePddlAction.Response
    ) -> UpdatePddlAction.Response:
        ...
        pddl_action_dto = self.msg_dto_parser.action_msg_to_dto(req.pddl_action)
